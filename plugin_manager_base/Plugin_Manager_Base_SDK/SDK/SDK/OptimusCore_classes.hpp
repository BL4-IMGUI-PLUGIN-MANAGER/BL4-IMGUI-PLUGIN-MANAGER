...
{
public:
	class FName                                   Category;                                          // 0x0250(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   KernelName;                                        // 0x0258(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FOptimusExecutionDomain                ExecutionDomain;                                   // 0x0260(0x0020)(NativeAccessSpecifierPublic)
	struct FIntVector                             GroupSize;                                         // 0x0280(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_28C[0x4];                                      // 0x028C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FOptimusParameterBinding>       InputBindings;                                     // 0x0290(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FOptimusParameterBinding>       OutputBindings;                                    // 0x02A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class FString                                 ShaderSource;                                      // 0x02B0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0250(0x0030)(NativeAccessSpecifierPublic)
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0250(0x0030)(NativeAccessSpecifierPrivate)
