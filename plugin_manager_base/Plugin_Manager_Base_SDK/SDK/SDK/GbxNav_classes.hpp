...
public:
	...
	uint8                                         Pad_150B[0x625];                                   // 0x150B(0x0625)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinTurnAngle;                                      // 0x1B30(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1B34[0xC];                                     // 0x1B34(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
