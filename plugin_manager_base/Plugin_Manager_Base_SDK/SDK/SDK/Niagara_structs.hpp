...
// ScriptStruct Niagara.GbxNiagaraComponentInstanceData
// 0x0100 (0x02D0 - 0x01D0)
struct FGbxNiagaraComponentInstanceData final : public FPrimitiveComponentInstanceData
{
public:
	struct FNiagaraUserRedirectionParameterStore  OverrideParameters;                                // 0x01D0(0x00D8)(NativeAccessSpecifierPublic)
	TArray<int32>                                 OverrideParametersObjectsIndices;                  // 0x02A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                 OverrideParametersDataInterfacesIndices;           // 0x02B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C8[0x8];                                      // 0x02C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FGbxNiagaraComponentInstanceData;
