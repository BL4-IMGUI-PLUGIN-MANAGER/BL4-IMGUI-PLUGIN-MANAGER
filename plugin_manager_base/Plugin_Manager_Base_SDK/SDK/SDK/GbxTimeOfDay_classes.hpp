...
public:
	...
	bool                                          bSkipTransitionOnSpawn;                            // 0x0415(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_416[0x12];                                     // 0x0416(0x0012)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnBrushComponentPhysicsStateChanged(class UPrimitiveComponent* ChangedComponent, EComponentPhysicsStateChange StateChange);
...
// Class GbxTimeOfDay.TimeOfDayWeatherOverrideVolume
// 0x0018 (0x03E0 - 0x03C8)
class ATimeOfDayWeatherOverrideVolume final : public AVolume
{
public:
	float                                         TransitionTime;                                    // 0x03C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   WeatherLayer;                                      // 0x03CC(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         priority;                                          // 0x03D4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSkipTransitionOnSpawn;                            // 0x03D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("TimeOfDayWeatherOverrideVolume")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"TimeOfDayWeatherOverrideVolume")
	}
	static class ATimeOfDayWeatherOverrideVolume* GetDefaultObj()
	{
		return GetDefaultObjImpl<ATimeOfDayWeatherOverrideVolume>();
	}
};
