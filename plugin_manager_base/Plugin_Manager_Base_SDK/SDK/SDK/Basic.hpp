...
namespace Offsets
{
	constexpr int32 GObjects          = 0x1141A8F0;
	constexpr int32 AppendString      = 0x01154540;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 GWorld            = 0x00000000;
	constexpr int32 ProcessEvent      = 0x014F8AB0;
...
// DUMPER7_ASSERTS_FFieldClass; // Struct layout changed in updated SDK - assertion disabled
