...
// Class MovieSceneTracks.GbxMovieSceneMaterialParameterSection
// 0x0020 (0x0180 - 0x0160)
class UGbxMovieSceneMaterialParameterSection : public UMovieSceneParameterSection
{
public:
	TArray<struct FScalarMaterialParameterNameAndCurve> ScalarMaterialParameterNamesAndCurves;       // 0x0160(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FColorMaterialParameterNameAndCurves> ColorMaterialParameterNamesAndCurves;        // 0x0170(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)

public:
	void AddColorMaterialParameterKey(const struct FMaterialParameterInfo& InParameterInfo, const struct FFrameNumber& InTime, const struct FLinearColor& InValue);
	void AddScalarMaterialParameterKey(const struct FMaterialParameterInfo& InParameterInfo, const struct FFrameNumber& InTime, float InValue);
	bool RemoveColorMaterialParameter(const class FName& InParameterName);
	bool RemoveScalarMaterialParameter(const class FName& InParameterName);

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("GbxMovieSceneMaterialParameterSection")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"GbxMovieSceneMaterialParameterSection")
	}
	static class UGbxMovieSceneMaterialParameterSection* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGbxMovieSceneMaterialParameterSection>();
	}
};
DUMPER7_ASSERTS_UGbxMovieSceneMaterialParameterSection;
...
public:
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSkeletalAnimationParams     params;                                            // 0x0100(0x0170)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UAnimSequence*                          AnimSequence;                                      // 0x0270(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAnimSequenceBase*                      Animation;                                         // 0x0278(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         StartOffset;                                       // 0x0280(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         EndOffset;                                         // 0x0284(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         PlayRate;                                          // 0x0288(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bReverse : 1;                                      // 0x028C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_28D[0x3];                                      // 0x028D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SlotName;                                          // 0x0290(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                StartLocationOffset;                               // 0x0298(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               StartRotationOffset;                               // 0x02B0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	class FName                                   MatchedBoneName;                                   // 0x02C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_301[0x77];                                     // 0x0301(0x0077)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// Class MovieSceneTracks.GbxMovieSceneSkeletalAnimationSection
// 0x0000 (0x0380 - 0x0380)
#pragma pack(push, 0x1)
class alignas(0x10) UGbxMovieSceneSkeletalAnimationSection : public UMovieSceneSkeletalAnimationSection
{
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("GbxMovieSceneSkeletalAnimationSection")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"GbxMovieSceneSkeletalAnimationSection")
	}
	static class UGbxMovieSceneSkeletalAnimationSection* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGbxMovieSceneSkeletalAnimationSection>();
	}
};
#pragma pack(pop)
DUMPER7_ASSERTS_UGbxMovieSceneSkeletalAnimationSection;
...
// Class MovieSceneTracks.GbxMovieSceneSkeletalAnimationTrack
// 0x0000 (0x01A0 - 0x01A0)
class UGbxMovieSceneSkeletalAnimationTrack : public UMovieSceneSkeletalAnimationTrack
{
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("GbxMovieSceneSkeletalAnimationTrack")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"GbxMovieSceneSkeletalAnimationTrack")
	}
	static class UGbxMovieSceneSkeletalAnimationTrack* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGbxMovieSceneSkeletalAnimationTrack>();
	}
};
DUMPER7_ASSERTS_UGbxMovieSceneSkeletalAnimationTrack;
